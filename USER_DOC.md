...
### URLs
* **Main Website**: [https://nadahman.42.fr](https://nadahman.42.fr)
* **WordPress Admin Panel**: [https://nadahman.42.fr/wp-admin](https://nadahman.42.fr/wp-admin)

## 4. Managing Credentials
All sensitive information and credentials (usernames, passwords, database names) are stored in the environment file:
`./srcs/.env`
